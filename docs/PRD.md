...
目标是验证导航、信息层级、编辑式极简、局部磨砂玻璃、抽屉阻力、地图惯性与自动吸附，不接后端。
...
- 移动端优先，首版基准视口为 393 × 852px；
- 页面主体采用平面编辑式排版，不做 SaaS 卡片矩阵；
- 磨砂玻璃只用于导航、控制和浮层；
- 重要内容区域不套满屏半透明卡片；
- 底部导航和 Agent 入口保持空间层级，但不使用蓝紫霓虹和持续发光；
- 地图和抽屉承担明显惯性、阻力和吸附；
- 普通内容动画快速、克制；
