...
> [!WARNING]
> 本文形成于 Book 原型和实验性后端收敛之前，其中“今日｜学习｜知识库”、跨库 Agent、注册流程和知识地图等内容仍包含旧的信息架构假设。它们可以作为长期产品讨论材料，但不表示 PR #7 已经实现，也不表示 API 和页面结构已经冻结。当前代码状态、能力边界和验收标准以 [`MVP_SCOPE.md`](MVP_SCOPE.md) 为准。
