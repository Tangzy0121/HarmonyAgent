...
import type { LociGlassSpec } from './materials'
import { lociGlassPresets } from './materials'
...
export function LociGlass({
  ...
  const glassStyle: GlassStyle = {
    ...
    '--loci-glass-dispersion-cyan': `rgb(74 190 255 / ${dispersionAlpha})`,
    '--loci-glass-dispersion-violet': `rgb(151 90 255 / ${dispersionAlpha * 0.82})`,
